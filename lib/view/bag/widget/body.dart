    ...
    return Container(
      ...
      child: FadeAnimation(
        ...
        child: Row(
          ...
          children: [
            const Text("购物袋", style: AppThemes.bagTitle),
            Text(
              "共 ${lengthsOfItemsOnBag} 件商品",
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text("¥${currentBagItem.price.toStringAsFixed(0)}",
        ...
        children: [
          FadeAnimation(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text("合计", style: AppThemes.bagTotalPrice),
                Text("¥${AppMethods.sumOfItemsOnBag().toStringAsFixed(0)}",
