  ...
  moreDetailsText(width, height) {
    return FadeAnimation(
      ...
      child: Container(
        ...
        height: height / 26,
        child: FittedBox(
            child: Text('更多详情', style: AppThemes.detailsMoreText)),
      ),
    );
  }
  ...
  shoeInfo(width, height) {
    return FadeAnimation(
      ...
      child: Container(
        ...
        height: height / 9,
        child: Text(
            "这款球鞋采用优质材料精心打造，轻盈透气，穿着舒适。创新的缓震科技为您提供出色的脚感体验，无论是日常穿搭还是运动健身，都是您的理想选择。经典设计与现代工艺的完美结合，彰显您的独特品味。",
    ...
    return FadeAnimation(
      ...
      child: Row(
        children: [
          ...
          Text('¥${widget.model.price.toStringAsFixed(0)}',
